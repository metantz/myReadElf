...
#should check arrays boundaries
	...
	if eiData == '01':
		print "\tVersion:\t\t\t0x"+ change_endianess(eversion)
		print "\tEntry Point Address:\t\t0x"+ change_endianess(eentry)
		print "\tProgram Header offset:\t\t0x"+change_endianess(ephoff)
		print "\tSection Header offset:\t\t0x"+change_endianess(eshoff)
		print "\tFlags:\t0x"+change_endianess(eflags)
		print "\tELF Header Size:\t\t",int(change_endianess(ehsize),16)," (byte)"
		print "\tProgram Header Entry Size:\t",int(change_endianess(ephentsize),16)," (byte)"
		print "\tProgram Header Entries:\t\t",int(change_endianess(ephnum),16)
		print "\tSection Header Entry Size:\t",int(change_endianess(eshentsize),16)," (byte)"
		print "\tSection Header Entries:\t\t",int(change_endianess(eshnum),16)
		print "\tSection name string table's index in Section Header: ",int(change_endianess(eshstrndx),16)
	else:
		print "\tVersion:\t\t\t0x"+ eversion
		print "\tEntry Point Address:\t\t0x"+ eentry
		print "\tProgram Header offset:\t\t0x"+ ephoff
		print "\tSection Header offset:\t\t0x"+ eshoff
		print "\tFlags:\t"+ eflags
		print "\tELF Header Size:\t\t",int(ehsize,16)," (byte)"
		print "\tProgram Header Entry Size:\t",int(ephentsize,16)," (byte)"
		print "\tProgram Header Entries:\t",int(ephnum,16)
		print "\tSection Header Entry Size:\t",int(eshentsize,16)," (byte)"
		print "\tSection Header Entries:\t",int(eshnum,16)
		print "\tSection name string table's index in Section Header: ",int(eshstrndx,16)
